    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tournaments', to='TournamentMaker.address')),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tournaments', to='TournamentMaker.city')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_match', models.ForeignKey(blank=True, help_text="Match suivant dans le bracket d'élimination", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='previous_matches', to='TournamentMaker.match')),
