    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phase', models.CharField(choices=[('pool', 'Phase de poule'), ('round_of_32', 'Seizième de finale'), ('eighth', 'Huitième de finale'), ('quarter', 'Quart de finale'), ('semi', 'Demi-finale'), ('final', 'Finale'), ('third_place', 'Petite finale')], default='pool', max_length=20)),
