    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type_tournament",
                    models.CharField(
                        choices=[("RR", "Round Robin"), ("DE", "Direct Elimination")],
                        default="RR",
                        max_length=2,
                    ),
                ),
                (
                    ...
                    models.PositiveIntegerField(
                        default=3,
                        help_text="Nombre de sets nécessaires pour gagner un match",
                    ),
                ),
                (
                    "points_per_set",
                    models.PositiveIntegerField(
                        default=25,
                        help_text="Nombre de points nécessaires pour gagner un set",
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, to="TournamentMaker.team"
            ),
        ),
        migrations.CreateModel(
            name="Player",
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                ...
                to="TournamentMaker.userprofile",
            ),
        ),
    ]
