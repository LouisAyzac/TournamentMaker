# Generated   by Django 5.2 on 2025-06-17 08:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sport', models.CharField(choices=[('football', 'Football'), ('volleyball', 'Volleyball'), ('basketball', 'Basketball'), ('rugby', 'Rugby')], default='football', max_length=50)),
                ...
                ('type_tournament', models.CharField(choices=[('RR', 'Round Robin'), ('DE', 'Direct Elimination')], default='RR', max_length=2)),
                ...
                ('match_duration', models.PositiveIntegerField(blank=True, help_text='Durée d’un match (en minutes)', null=True)),
                ('extra_time', models.BooleanField(blank=True, help_text='Prolongations possibles', null=True)),
                ('penalty_shootout', models.BooleanField(blank=True, help_text='Tirs au but en cas d’égalité', null=True)),
                ('half_time_duration', models.PositiveIntegerField(blank=True, help_text='Durée de la mi-temps (en minutes)', null=True)),
                ('quarter_duration', models.PositiveIntegerField(blank=True, help_text='Durée d’un quart-temps (en minutes)', null=True)),
                ('number_of_quarters', models.PositiveIntegerField(blank=True, help_text='Nombre de quart-temps', null=True)),
        ...
        migrations.AddField(
            model_name='pool',
            name='tournament',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pools', to='TournamentMaker.tournament'),
        ),
        migrations.CreateModel(
            name='Match',
            fields=[
                ...
                ('next_match', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='previous_matches', to='TournamentMaker.match')),
                ...
                ('team_a', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='matches_as_team_a', to='TournamentMaker.team')),
                ('team_b', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='matches_as_team_b', to='TournamentMaker.team')),
