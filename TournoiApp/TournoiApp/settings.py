"""
Django settings for TournoiApp project.
...
SECRET_KEY = 'django-insecure-2f$c!o#6ad9ozm*xzn!_2(+q6g-ve=_(r9_%p^2c*y*)=00u-c'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # ✅ Ajout : injection automatique de "tournoi" dans tous les templates
...
WSGI_APPLICATION = 'TournoiApp.wsgi.application'
